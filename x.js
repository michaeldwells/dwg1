...
function sfc32(a, b, c, d) { // Pseudo-random number generator with 128-bit seed.
    return function() {
      a >>>= 0; b >>>= 0; c >>>= 0; d >>>= 0; 
      var t = (a + b) | 0;
      a = b ^ b >>> 9;
...
function mulberry32(a) { // Pseudo-random number generator with 32-bit seed.
    return function() {
      var t = a += 0x6D2B79F5;
...
var prng;
var prng_seed;
function seedPrng(s = hash(Date.now().toString())) {
	prng_seed = s;
	prng = prgn_generator(prng_seed);
}
seedPrng();
